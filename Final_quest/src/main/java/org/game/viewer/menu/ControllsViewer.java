...
public class ControllsViewer extends Viewer<ControllManual> {
  ...
  @Override
    public void drawElements(GUI gui) throws IOException {
        gui.drawText(new Position(12,7),"Press 'Z' to interact with the world" , "#008000");
        gui.drawText(new Position(12,10),"Press 'P' check your status/inventory" , "#008000");
        ...
        gui.drawText(new Position(12,25),"If you ever rage press 'Q' to end it all" , "#008000");
